...
<div class="div">
    <div class="div-2">
        <span class="span">
            <div class="div-3">Product</div>
            <div class="div-4">Price</div>
            <div class="div-5">Quantity</div>
            <div class="div-6">Subtotal</div>
        </span>
    </div>
    ...
    <span class="span-2">
        <span class="span-3">
            ...
            <div class="div-7">LCD Monitor</div>
        </span>
        <div class="div-8">$650</div>
        <img loading="lazy" srcset="..." class="img-2" />
        <div class="div-9">$650</div>
    </span>
    ...
    <span class="span-4">
        <span class="span-5">
            ...
            <div class="div-10">H1 Gamepad</div>
        </span>
        <div class="div-11">$550</div>
        <img loading="lazy" srcset="..." class="img-4" />
        <div class="div-12">$1100</div>
    </span>
    <div class="div-13">
        <span class="span-6">Return To Shop</span>
        <span class="span-7">Update Cart</span>
    </div>
    <div class="div-14">
        <div class="div-15">
            <div class="column">
                <div class="div-16">
                    <span class="span-8">Coupon Code</span>
                    <span class="span-9">Apply Coupon</span>
                </div>
            </div>
            <div class="column-2">
                <span class="span-10">
